...
int main(void)
{
	...
	//SENSORS
	readingParameters.temp; //przypisac do czujnikow
	readingParameters.hum;
	readingParameters.press;
...
void sensorReading() {
	...
	if (result == BME280_OK) {
		...
		if (result == BME280_OK) {
			readingParameters.temp = data.temperatureC;
			readingParameters.hum = data.humidityPercent;
			readingParameters.press = data.pressurePa/100;
		}
	}
}
